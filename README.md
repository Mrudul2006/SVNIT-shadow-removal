...
Alternative Download: If the command line download fails, manually download the zip file from the Google Drive link and extract it into the `weights` directory.
